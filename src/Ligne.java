...
class Ligne{
	...
	public static Stack<Ligne> vect_clone(Stack<Ligne> lignes){
	...
	public static Stack<Ligne> setCurve(Ligne l){
		double t=0.0;
		double dx,ax,dy,ay;
		Stack<Ligne> vect_l=new Stack<>();
		dx =l.pArrivee.x;
		dy =l.pArrivee.y;
	...
	public static Stack<Ligne> conv_curve(Stack<Ligne> lignes){		
		Stack<Ligne> vect_l=new Stack();
                lignes.forEach((l) -> {
